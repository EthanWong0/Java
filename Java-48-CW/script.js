...
async function init(){  
  let link = "https://cautious-telegram-q7j6jjgr97rhxw7j-8505.app.github.dev";// Insert your Dev URL from Activity 47. The activity (DB server) must be running in a separate tab.
  let route= "/employees";
  ...
  */
  ...
  // Problem 3: For each employee, display their first name, last name and birthdate to the console.
   for(let i = 0; i < employees.length; i++){
    ...
    console.log("First Name: " + employees.FirstName);
    console.log("Last name: " + employees.LastName);
    console.log("Birthdate: " + employees.BirthDate);
   }
