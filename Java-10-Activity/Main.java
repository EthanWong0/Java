class Main {
   ...
   System.out.println(gpa(88));
   System.out.println(isGraduating(12,45));
   System.out.println(BMI(198,6));
   System.out.println(shippingCost(14));
...
*/
 String BMI(double weight, double height){
  double BMI = (weight/Math.pow(height,2))*703.0;
  if(BMI <= 18.4){
    return "Underweight";
