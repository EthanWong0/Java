...
class Main {
 ...
 public static void main(String[] args)throws IOException{
  ...
  void init() throws IOException{   
    ...
    Database db = new Database("jdbc:sqlite:cars.db");
    ...
    */
    ...
    // Employee route
    String sql = "";
    sql = " SELECT cars.CarID, cars.Model, cars.Value, cars.Loaned, dealership.DealershipID, dealership.Name, dealership.Country, dealership.TotalCars FROM cars";
    sql += " INNER JOIN dealership ON dealership.DealershipID = cars.DealershipID";
    server.createContext("/cars", new RouteHandler(db,sql));
